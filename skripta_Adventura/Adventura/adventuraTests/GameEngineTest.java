...
class GameEngineTest {
  ...
  void gameRun() {
    ...
    assertTrue(game.getBackpack().getItems().size() == 2);
    assertTrue(game.getLives() == 3);
    game.process(Command.initialize("eat chocolate"));
    
    assertTrue(game.getBackpack().getItems().size() == 1);
    ...
    assertTrue(game.getBackpack().getItems().size() == 0);
    ...
    assertTrue(game.getBackpack().getItems().size() == 3);
    game.process(Command.initialize("enter green room"));
